...
const NewResponseCart = ({ item }) => {
    return (
        <div className="block">
            <div className="top">
                <p className="name">Вы откликнулись на заявку!</p>
            </div>
            <div className="request_comment">
                <p>Перейдите в раздел отклики, для получения контактов пользователя и дальнейшего обсуждения заказа.</p>
            </div>
            ...
            <div className="bottom">
                ...
                <div className="timing">
                    <NavLink to="/lc/responses" className="timing_p__clicked">
                        Перейти
                        <span>
                            <svg
                                width="19"
...
export default NewResponseCart;
